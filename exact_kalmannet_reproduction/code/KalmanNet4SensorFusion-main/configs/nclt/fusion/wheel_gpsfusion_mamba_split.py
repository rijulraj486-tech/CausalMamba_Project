...
from Net.mamba_kalman import MambaSplitKalmanNet
...
logger = dict(
    project='new_exp',
    name=f'Wheel_GPS_l{train_seq_len}w{slide_win_size}step{detach_step}_mamba_split',
    offline=True)
